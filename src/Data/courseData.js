const courseData = {
    "frontend-development": {
      ...
      description:
        "Learn HTML, CSS, JavaScript, React & UI/UX fundamentals. Become a web developer.",
      fee: "₹12,000",
      duration: "3 Months",
      discount: "₹10,000",
    ...
    "backend-development": {
      ...
      description:
        "Learn Node.js, Express, MongoDB & REST APIs. Master backend programming for scalable applications.",
      fee: "₹15,000",
      duration: "4 Months",
      discount: "₹13,000",
    ...
    "programming-fundamentals": {
      ...
      description:
        "Start from the basics and build strong foundations in C, C++, Python, and Java.",
      fee: "₹10,000",
      duration: "3 Months",
      discount: "₹8,000",
    ...
    "wordpress-development": {
      ...
      description:
        "Build websites quickly with WordPress, use themes, plugins, and customize with Elementor.",
      fee: "₹7,500",
      duration: "2 Months",
      discount: "₹6,000",
      ...
      syllabus: [
        ...
        "Using Themes and Page Builders",
        "Plugin Integration",
    ...
    "dsa": {
      ...
      description:
        "Learn DSA with hands-on problems. Prepare for coding interviews and tech challenges.",
      fee: "₹11,000",
      duration: "3.5 Months",
      discount: "₹9,000",
